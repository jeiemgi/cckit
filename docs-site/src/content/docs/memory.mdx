---
title: Set up memory with MemPalace
description: Give your coding agent persistent, per-project memory — why it helps, how cckit wires it in, and how to turn it on.
---
