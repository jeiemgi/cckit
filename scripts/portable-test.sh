...
SKIP="adopt autopilot close commands completions contribute copilot debug digest effort encode-context handoff help init install migrate orchestrate pr release render resume start ui update version watch"
