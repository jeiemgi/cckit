...
> effort are protected. Exactly one trailing lowercase letter is a sub suffix — anything
> else (`16a04`, `1604a4`, `1604A`) is not an issue number and yields no association.
